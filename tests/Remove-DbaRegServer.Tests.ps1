...
Describe "Remove-DbaRegServer" {
    ...
    Context "Command usage" {
        BeforeAll {
            ...
            $newServer = Add-DbaRegServer -SqlInstance $env:instance1 -ServerName $srvName -Name $regSrvName -Description $regSrvDesc
        ...
        AfterAll {
            Get-DbaRegServer -SqlInstance $env:instance1 -Name $regSrvName, $regSrvName2, $regSrvName3 | Remove-DbaRegServer -Confirm:$false
        }
        ...
        It "supports dropping manually" {
            $results = Remove-DbaRegServer -Confirm:$false -SqlInstance $env:instance1 -Name $regSrvName2
