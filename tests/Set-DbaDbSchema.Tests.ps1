...
Describe "$CommandName Integration Tests" -Tag "IntegrationTests" {
    ...
    Context "commands work as expected" {
        ...
        It "updates the schema to a different owner" {
            ...
            $updatedSchema = Set-DbaDbSchema -SqlInstance $instance1 -Database $newDbName -SchemaName TestSchema1 -SchemaOwner $userName2
            ...
            $updatedSchemas = Set-DbaDbSchema -SqlInstance $instance1, $instance2 -Database $newDbName -SchemaName TestSchema2, TestSchema3 -SchemaOwner $userName2
        ...
        It "supports piping databases" {
            $schema = Get-DbaDatabase -SqlInstance $instance1 -Database $newDbName | Set-DbaDbSchema -SchemaName TestSchema1 -SchemaOwner $userName
            $schema.Count | Should -Be 1
            $schema.Owner | Should -Be $userName
            $schema.Name | Should -Be TestSchema1
            $schema.Parent.Name | Should -Be $newDbName
