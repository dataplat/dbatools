...
Describe "$commandname Unit Tests" -Tag "UnitTests" {
    Context "Validate parameters" {
        ...
        [array]$knownParameters = 'InputObject', 'Property', 'ExcludeProperty', 'ExpandProperty', 'Alias', 'ScriptProperty', 'ScriptMethod', 'Unique', 'Last', 'First', 'Skip', 'SkipLast', 'Wait', 'Index', 'ShowProperty', 'ShowExcludeProperty', 'TypeName', 'KeepInputObject'
