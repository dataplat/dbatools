...
Describe "$CommandName Integration Tests" -Tags "IntegrationTests" {
    ...
    Context "Operations on databases" {
        ...
        AfterAll {
            Remove-DbaDbSnapshot -SqlInstance $script:instance2 -Database $db1, $db2, $db3 -Force
        ...
        if ($setupright) {
            ...
            It "Creates snaps for multiple dbs by default" {
                $result = New-DbaDbSnapshot -SqlInstance $script:instance2 -EnableException -Database $db1, $db2
            ...
            It "Has the correct properties" {
                $null = Remove-DbaDbSnapshot -SqlInstance $script:instance2 -Database $db2 -Force
                $result = New-DbaDbSnapshot -SqlInstance $script:instance2 -EnableException -Database $db2
