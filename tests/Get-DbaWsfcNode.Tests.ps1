...
Describe $CommandName -Tag IntegrationTests {
    BeforeAll {
        $results = Get-DbaWsfcNode -ComputerName $TestConfig.InstanceHadr -WarningVariable WarnVar -OutVariable "global:dbatoolsciOutput"
    }

    Context "Validate output" {
        It "Should return node information without errors" {
