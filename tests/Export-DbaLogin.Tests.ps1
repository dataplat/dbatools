...
Describe $CommandName -Tag IntegrationTests {
    BeforeAll {
        ...
        # Initialize array to track files for cleanup
        $global:allfiles = @()
    ...
    AfterAll {
        ...
        # Cleanup databases and logins
        Remove-DbaDatabase -SqlInstance $TestConfig.instance2 -Database $global:dbname1, $global:dbname2 -ErrorAction SilentlyContinue
        Remove-DbaLogin -SqlInstance $TestConfig.instance2 -Login $global:login1, $global:login2, $global:login3 -ErrorAction SilentlyContinue
        ...
        if ($ExportedCredential) {
            Remove-Item -Path $ExportedCredential.FullName -ErrorAction SilentlyContinue
        }
