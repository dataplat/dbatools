...
Describe "$CommandName Integration Tests" -Tag "IntegrationTests" {
    # $global:instance3 to add to the 2016_2017 matrix
    ...
    Get-DbaProcess $global:instance2 -ExcludeSystemSpids | Stop-DbaProcess -WarningVariable warn -WarningAction SilentlyContinue
    ...
    Context "Replace databasename in Restored File" {
        $results = Get-ChildItem $global:appveyorlabrepo\singlerestore\singlerestore.bak | Restore-DbaDatabase -SqlInstance $global:instance2 -DatabaseName Pestering -replaceDbNameInFile -WithReplace
    ...
    Context "Database is properly removed (name change)" {
        $results = Remove-DbaDatabase -Confirm:$false -SqlInstance $global:instance2 -Database pestering
        It "Should say the status was dropped" {
            $results.Status | Should Be "Dropped"
        }
    ...
    Context "Test restoring as other login #6992" {
        ...
        $results = Get-ChildItem $global:appveyorlabrepo\singlerestore\singlerestore.bak | Restore-DbaDatabase -SqlInstance $global:instance2 -DatabaseName Pestering -replaceDbNameInFile -WithReplace
        $db = Get-DbaDatabase -SqlInstance $global:instance2 -Database Pestering
        It "Should Not be owned by SA this time" {
            $db.owner | Should Not Be "sa"
        }

        Remove-DbaDatabase -SqlInstance $global:instance2 -Database Pestering -Confirm:$false

        $results = Get-ChildItem $global:appveyorlabrepo\singlerestore\singlerestore.bak | Restore-DbaDatabase -SqlInstance $global:instance2 -DatabaseName Pestering -replaceDbNameInFile -WithReplace -ExecuteAs badlogin -WarningVariable warnvar
        $db = Get-DbaDatabase -SqlInstance $global:instance2 -Database Pestering
        ...
        $results = Get-ChildItem $global:appveyorlabrepo\singlerestore\singlerestore.bak | Restore-DbaDatabase -SqlInstance $global:instance2 -DatabaseName Pestering -replaceDbNameInFile -WithReplace -ExecuteAs sa
        $db = Get-DbaDatabase -SqlInstance $global:instance2 -Database Pestering
        ...
        New-DbaLogin -SqlInstance $global:instance2 -Login $RestoreAsUser -SecurePassword (ConvertTo-SecureString 'P@ssw0rdl!ng' -AsPlainText -Force) -force
        Add-DbaServerRoleMember -SqlInstance $global:instance2 -ServerRole sysadmin -Login $RestoreAsUser -confirm:$false
        $results = Get-ChildItem $global:appveyorlabrepo\singlerestore\singlerestore.bak | Restore-DbaDatabase -SqlInstance $global:instance2 -DatabaseName Pestering -replaceDbNameInFile -WithReplace -ExecuteAs $RestoreAsUser
        $db2 = Get-DbaDatabase -SqlInstance $global:instance2 -Database Pestering
        It "Should be owned by $RestoreAsUser this time" {
            $db2.owner | Should Be "$RestoreAsUser"
        }

        $results6 = Get-ChildItem $global:appveyorlabrepo\singlerestore\singlerestore.bak | Restore-DbaDatabase -SqlInstance $global:instance2 -DatabaseName Pestering -replaceDbNameInFile -WithReplace -ExecuteAs $RestoreAsUser -OutputScriptOnly
    ...
    Context "Folder restore options" {
        $results = Get-ChildItem $global:appveyorlabrepo\singlerestore\singlerestore.bak | Restore-DbaDatabase -SqlInstance $global:instance2 -DestinationDataDirectory $DataFolder
        ...
        $results = Get-ChildItem $global:appveyorlabrepo\singlerestore\singlerestore.bak | Restore-DbaDatabase -SqlInstance $global:instance2 -DestinationDataDirectory $DataFolder -DestinationLogDirectory $LogFolder -WithReplace
    ...
    Context "Putting all restore file modification options together" {
        $results = Get-ChildItem $global:appveyorlabrepo\singlerestore\singlerestore.bak | Restore-DbaDatabase -SqlInstance $global:instance2 -DestinationDataDirectory $DataFolder -DestinationLogDirectory $LogFolder -DestinationFileSuffix Suffix -DestinationFilePrefix prefix
    ...
    Context "Should proceed if backups from multiple dbs passed in and databasename specified" {
        $results = Get-ChildItem $global:appveyorlabrepo\sql2008-backups | Restore-DbaDatabase -SqlInstance $global:instance2 -DatabaseName test -WarningVariable warnvar
    ...
    Context "Database is properly removed again after ola pipe test" {
        Get-DbaProcess $global:instance2 -ExcludeSystemSpids | Stop-DbaProcess -WarningVariable warn -WarningAction SilentlyContinue
        $results = Get-DbaDatabase -SqlInstance $global:instance2 -ExcludeSystem | Remove-DbaDatabase -Confirm:$false
        Get-DbaProcess $global:instance2 -ExcludeSystemSpids | Stop-DbaProcess -WarningVariable warn -WarningAction SilentlyContinue
        $results = Get-DbaDatabase -SqlInstance $global:instance2 -ExcludeSystem | Remove-DbaDatabase -Confirm:$false
    ...
    Context "RestoreTime setup checks" {
        ...
        $sqlResults = Invoke-DbaQuery -SqlInstance $global:instance2 -Query "select convert(datetime,convert(varchar(20),max(dt),120)) as maxdt, convert(datetime,convert(varchar(20),min(dt),120)) as mindt from RestoreTimeClean.dbo.steps"
    ...
    Context "RestoreTime point in time with Simple Model" {
        ...
        $sqlResults = Invoke-DbaQuery -SqlInstance $global:instance2 -Query "select convert(datetime,convert(varchar(20),max(dt),120)) as maxdt, convert(datetime,convert(varchar(20),min(dt),120)) as mindt from SimpleBackTest.dbo.steps"
    ...
    Context "RestoreTime point in time and continue" {
        ...
        $Should_Run = (Connect-DbaInstance -SqlInstance $global:instance2).Version.ToString() -like '13.*'
        if (-not ($Should_Run)) {
            It "The test can run" {
        ...
        $results = Restore-DbaDatabase -SqlInstance $global:instance2 -path $global:appveyorlabrepo\RestoreTimeClean2016 -RestoreTime (Get-Date "2019-05-02 21:12:27") -StandbyDirectory c:\temp -WarningVariable warnvar -ErrorVariable errvar -ErrorAction SilentlyContinue
        $sqlResults = Invoke-DbaQuery -SqlInstance $global:instance2 -Query "select convert(datetime,convert(varchar(20),max(dt),120)) as maxdt, convert(datetime,convert(varchar(20),min(dt),120)) as mindt from RestoreTimeClean.dbo.steps"
        $warnvar
        It "Should not warn" {
        ...
        $results2 = Restore-DbaDatabase -SqlInstance $global:instance2 -path $global:appveyorlabrepo\RestoreTimeClean2016 -Continue
        $sqlResults2 = Invoke-DbaQuery -SqlInstance $global:instance2 -Query "select convert(datetime,convert(varchar(20),max(dt),120)) as maxdt, convert(datetime,convert(varchar(20),min(dt),120)) as mindt from RestoreTimeClean.dbo.steps"
        It "Should have restored 4 files" {
    ...
    Context "RestoreTime point in time and continue with rename" {
        ...
        $results = Restore-DbaDatabase -SqlInstance $global:instance2 -Databasename contest -path $global:appveyorlabrepo\RestoreTimeClean2016 -RestoreTime (Get-Date "2019-05-02 21:23:58") -StandbyDirectory c:\temp
        $sqlResults = Invoke-DbaQuery -SqlInstance $global:instance2 -Query "select convert(datetime,convert(varchar(20),max(dt),120)) as maxdt, convert(datetime,convert(varchar(20),min(dt),120)) as mindt from contest.dbo.steps"
        It "Should have restored 4 files" {
            $results.count | Should be 4
        }
        It "Should have restored from 05/02/2019 21:00:55" {
        ...
        $results2 = Restore-DbaDatabase -SqlInstance $global:instance2 -Databasename contest -path $global:appveyorlabrepo\RestoreTimeClean2016 -Continue
        $sqlResults2 = Invoke-DbaQuery -SqlInstance $global:instance2 -Query "select convert(datetime,convert(varchar(20),max(dt),120)) as maxdt, convert(datetime,convert(varchar(20),min(dt),120)) as mindt from contest.dbo.steps"
        It "Should have restored 2 files" {
    ...
    Context "Continue Restore with Differentials" {
        ...
        $Results = Restore-DbaDatabase -SqlInstance $global:instance2 -Path $global:appveyorlabrepo\sql2008-backups\ft1\FULL\ -NoRecovery
        ...
        It "Should have left the db in a norecovery state" {
            (Get-DbaDatabase -SqlInstance $global:instance2 -Database ft1).Status | Should Be "Restoring"
        }
        $Results2 = Restore-DbaDatabase -SqlInstance $global:instance2 -Path $global:appveyorlabrepo\sql2008-backups\ft1\ -Continue
        It "Should Have restored the database cleanly" {
            ($results.RestoreComplete -contains $false) | Should be $False
            (($results | Measure-Object).count -gt 0) | Should be $True
        }
        It "Should have recovered the database" {
            (Get-DbaDatabase -SqlInstance $global:instance2 -Database ft1).Status | Should Be "Normal"
        }
    }
    ...
    Context "Continue Restore with Differentials and rename " {
        ...
        $Results = Restore-DbaDatabase -SqlInstance $global:instance2 -DatabaseName contest -Path $global:appveyorlabrepo\sql2008-backups\ft1\FULL\ -NoRecovery
        It "Should Have restored the database cleanly" {
            ($results.RestoreComplete -contains $false) | Should be $False
            (($results | Measure-Object).count -gt 0) | Should be $True
        }
        It "Should have left the db in a norecovery state" {
            (Get-DbaDatabase -SqlInstance $global:instance2 -Database contest).Status | Should Be "Restoring"
        }
        $Results2 = Restore-DbaDatabase -SqlInstance $global:instance2 -DatabaseName contest -Path $global:appveyorlabrepo\sql2008-backups\ft1\ -Continue
        It "Should Have restored the database cleanly" {
            ($results2.RestoreComplete -contains $false) | Should be $False
            (($results2 | Measure-Object).count -gt 0) | Should be $True
        }
        It "Should have recovered the database" {
            (Get-DbaDatabase -SqlInstance $global:instance2 -Database contest).Status | Should Be "Normal"
        }
    }
    ...
    Context "Continue Restore with multiple databases" {
        ...
        $files = @()
        $files += Get-ChildItem $global:appveyorlabrepo\sql2008-backups\db1\FULL\
        $files += Get-ChildItem $global:appveyorlabrepo\sql2008-backups\dbareports\FULL
        $Results = $files | Restore-DbaDatabase -SqlInstance $global:instance2  -NoRecovery
        It "Should Have restored the database cleanly" {
            ($results.RestoreComplete -contains $false) | Should be $False
            (($results | Measure-Object).count -gt 0) | Should be $True
        }
        It "Should have left the db in a norecovery state" {
            (Get-DbaDatabase -SqlInstance $global:instance2 | Where-Object { $_.Status -eq 'Recovering' }).count | Should Be 0
        }
        $files = @()
        $files += Get-ChildItem $global:appveyorlabrepo\sql2008-backups\db1\ -Recurse
        $files += Get-ChildItem $global:appveyorlabrepo\sql2008-backups\dbareports\ -Recurse
        $Results2 = $files | Where-Object { $_.PsIsContainer -eq $false } | Restore-DbaDatabase -SqlInstance $global:instance2 -Continue
        It "Should Have restored the database cleanly" {
            ($results2.RestoreComplete -contains $false) | Should be $False
            (($results2 | Measure-Object).count -gt 0) | Should be $True
        }
    ...
    Context "Backup DB For next test" {
        $null = Restore-DbaDatabase -SqlInstance $global:instance2 -path $global:appveyorlabrepo\RestoreTimeClean2016\restoretimeclean.bak
        $results = Backup-DbaDatabase -SqlInstance $global:instance2 -Database RestoreTimeClean -BackupDirectory C:\temp
    ...
    Get-DbaProcess $global:instance2 | Where-Object Program -match 'dbatools PowerShell module - dbatools.io' | Stop-DbaProcess -WarningAction SilentlyContinue
    Context "Check Get-DbaDbBackupHistory pipes into Restore-DbaDatabase" {
        $history = Get-DbaDbBackupHistory -SqlInstance $global:instance2 -Database RestoreTimeClean -Last
        $results = $history | Restore-DbaDatabase -SqlInstance $global:instance2 -WithReplace -TrustDbBackupHistory
    ...
    Context "Restores a db with log and file files missing extensions" {
        $results = Restore-DbaDatabase -SqlInstance $global:instance2 -path $global:appveyorlabrepo\sql2008-backups\Noextension.bak -ErrorVariable Errvar -WarningVariable WarnVar
    ...
    Context "Setup for Recovery Tests" {
        ...
        $results = Restore-DbaDatabase -SqlInstance $global:instance2 -Path $global:appveyorlabrepo\singlerestore\singlerestore.bak -NoRecovery -DatabaseName $DatabaseName -DestinationFilePrefix $DatabaseName -WithReplace
        It "Should have restored everything successfully" {
            ($results.RestoreComplete -contains $false) | Should be $False
            (($results | Measure-Object).count -gt 0) | Should be $True
        }
        $check = Get-DbaDatabase -SqlInstance $global:instance2 -Database $DatabaseName
    ...
    Context "Test recovery via parameter" {
        $DatabaseName = 'rectest'
        $results = Restore-DbaDatabase -SqlInstance $global:instance2 -Recover -DatabaseName $DatabaseName
        It "Should have restored everything successfully" {
            ($results.RestoreComplete -contains $false) | Should be $False
            (($results | Measure-Object).count -gt 0) | Should be $True
        }
    ...
    Context "Test recovery via pipeline" {
        $DatabaseName = 'rectest'
        $results = Get-DbaDatabase -SqlInstance $global:instance2 -Database $DatabaseName | Restore-DbaDatabase -SqlInstance $global:instance2 -Recover
        It "Should have restored everything successfully" {
            ($results.RestoreComplete -contains $false) | Should be $False
            (($results | Measure-Object).count -gt 0) | Should be $True
        }
    ...
    Context "Checking we cope with a port number (#244)" {
        $DatabaseName = 'rectest'
        $results = Restore-DbaDatabase -SqlInstance $global:instance2_detailed -Path $global:appveyorlabrepo\singlerestore\singlerestore.bak -DatabaseName $DatabaseName -DestinationFilePrefix $DatabaseName -WithReplace
        It "Should have restored everything successfully" {
            ($results.RestoreComplete -contains $false) | Should be $False
            (($results | Measure-Object).count -gt 0) | Should be $True
        }
    ...
    Context "Checking OutputScriptOnly only outputs script" {
        ...
        $results = Restore-DbaDatabase -SqlInstance $global:instance2 -Path $global:appveyorlabrepo\singlerestore\singlerestore.bak -DatabaseName $DatabaseName -OutputScriptOnly
        $db = Get-DbaDatabase -SqlInstance $global:instance2 -Database $DatabaseName
    ...
    Context "Checking OutputScriptOnly only outputs script without changing state for existing dbs (#2940)" {
        ...
        Get-DbaDatabase -SqlInstance $global:instance2 -Database $DatabaseName | Remove-DbaDatabase -Confirm:$false
        $server = Connect-DbaInstance $global:instance2
        $server.Query("CREATE DATABASE $DatabaseName")
        $results = Restore-DbaDatabase -SqlInstance $global:instance2 -Path $global:appveyorlabrepo\singlerestore\singlerestore.bak -DatabaseName $DatabaseName -OutputScriptOnly -WithReplace
        $db = Get-DbaDatabase -SqlInstance $global:instance2 -Database $DatabaseName
        It "Should only output a script" {
            $results -match 'RESTORE DATABASE' | Should be $True
        }
    ...
    Context "Checking Output vs input" {
        $DatabaseName = 'rectestSO'
        $results = Restore-DbaDatabase -SqlInstance $global:instance2 -Path $global:appveyorlabrepo\singlerestore\singlerestore.bak -DatabaseName $DatabaseName -BufferCount 24 -MaxTransferSize 128kb -BlockSize 64kb

        It "Should return the destination instance" {
            $results.SqlInstance = $global:instance2
        }
    ...
    Context "Checking CDC parameter " {
        $output = Restore-DbaDatabase -SqlInstance $global:instance2 -Path $global:appveyorlabrepo\singlerestore\singlerestore.bak -DatabaseName $DatabaseName -OutputScriptOnly -KeepCDC -WithReplace
        It "Should have KEEP_CDC in the SQL" {
            ($output -like '*KEEP_CDC*') | Should be $True
        }
        $output = Restore-DbaDatabase -SqlInstance $global:instance2 -Path $global:appveyorlabrepo\singlerestore\singlerestore.bak -DatabaseName $DatabaseName -OutputScriptOnly -KeepCDC -WithReplace -WarningVariable warnvar -NoRecovery -WarningAction SilentlyContinue
        ...
        $output = Restore-DbaDatabase -SqlInstance $global:instance2 -Path $global:appveyorlabrepo\singlerestore\singlerestore.bak -DatabaseName $DatabaseName -OutputScriptOnly -KeepCDC -WithReplace -WarningVariable warnvar -StandbyDirectory c:\temp\ -WarningAction SilentlyContinue
    ...
    Context "Page level restores" {
        ...
        $null = Restore-DbaDatabase -SqlInstance $global:instance2 -Path $global:appveyorlabrepo\singlerestore\singlerestore.bak -DatabaseName PageRestore -DestinationFilePrefix PageRestore
        ...
        use master"
        $null = Invoke-DbaQuery -SqlInstance $global:instance2 -Query $sql -Database Pagerestore
        $sqlResults2 = Invoke-DbaQuery -SqlInstance $global:instance2 -Database Master -Query "select * from pagerestore.dbo.testpage where filler like 'a%'" -ErrorVariable errvar -ErrorAction SilentlyContinue
        ...
        $null = Get-DbaDbBackupHistory -SqlInstance $global:instance2 -Database pagerestore -last | Restore-DbaDatabase -SqlInstance $global:instance2 -PageRestore (Get-DbaSuspectPage -SqlInstance $global:instance2 -Database PageRestore) -TrustDbBackupHistory -DatabaseName PageRestore -PageRestoreTailFolder c:\temp -ErrorAction SilentlyContinue
        $sqlResults3 = Invoke-DbaQuery -SqlInstance $global:instance2 -Query "select * from pagerestore.dbo.testpage where filler like 'f%'" -ErrorVariable errvar3 -ErrorAction SilentlyContinue
    ...
    Context "Testing Backup to Restore piping" {
        Get-DbaDatabase -SqlInstance $global:instance2 -ExcludeSystem | Remove-DbaDatabase -Confirm:$false
        $null = Restore-DbaDatabase -SqlInstance $global:instance2 -Path $global:appveyorlabrepo\singlerestore\singlerestore.bak -DatabaseName PipeTest -DestinationFilePrefix PipeTest
        $results = Backup-DbaDatabase -SqlInstance $global:instance2 -Database Pipetest -BackupDirectory c:\temp -CopyOnly -WarningAction SilentlyContinue -WarningVariable bwarnvar -ErrorAction SilentlyContinue -ErrorVariable berrvar | Restore-DbaDatabase -SqlInstance $global:instance2 -DatabaseName restored -ReplaceDbNameInFile -WarningAction SilentlyContinue -WarningVariable rwarnvar -ErrorAction SilentlyContinue -ErrorVariable rerrvar
    ...
    Context "Check we restore striped database" {
        Get-DbaDatabase -SqlInstance $global:instance2 -ExcludeSystem | Remove-DbaDatabase -Confirm:$false
        $results = Restore-DbaDatabase -SqlInstance $global:instance2 -Path $global:appveyorlabrepo\sql2008-backups\RestoreTimeStripe -DatabaseName StripeTest -DestinationFilePrefix StripeTest
        It "Should backup and restore cleanly" {
            ($results | Where-Object { $_.RestoreComplete -eq $True }).count | Should Be $Results.count
        }
        $null = Remove-DbaDatabase -SqlInstance $global:instance2 -Database StripeTest
    }

    Context "Don't try to create/test folders with OutputScriptOnly (Issue 4046)" {
        $null = Restore-DbaDatabase -SqlInstance $global:instance2 -Path $global:appveyorlabrepo\RestoreTimeClean2016\RestoreTimeClean.bak -DestinationDataDirectory g:\DoesNtExist -OutputScriptOnly -WarningVariable warnvar
    ...
    Context "Checking that WITH KEEP_REPLICATION gets properly added" {
        ...
        $results = Restore-DbaDatabase -SqlInstance $global:instance2 -Path $global:appveyorlabrepo\singlerestore\singlerestore.bak -DatabaseName $DatabaseName -OutputScriptOnly -KeepReplication
    ...
    Context "Test restoring a Backup encrypted with Certificate" {
        New-DbaDatabase -SqlInstance $global:instance2 -Name EncRestTest -Confirm:$false
        $securePass = ConvertTo-SecureString "estBackupDir\master\script:instance1).split('\')[1])\Full\master-Full.bak" -AsPlainText -Force
        New-DbaDbMasterKey -SqlInstance $global:instance2 -Database Master -SecurePassword $securePass -confirm:$false
        $cert = New-DbaDbCertificate -SqlInstance $global:instance2 -Database Master -Name RestoreTestCert -Subject RestoreTestCert
        $encBackupResults = Backup-DbaDatabase -SqlInstance $global:instance2 -Database EncRestTest -EncryptionAlgorithm AES128 -EncryptionCertificate RestoreTestCert
        ...
        $results = $encBackupResults | Restore-DbaDatabase -SqlInstance $global:instance2 -TrustDbBackupHistory -RestoredDatabaseNamePrefix cert -DestinationFilePrefix cert -confirm:$false
        It "Should have restored the backup" {
            $results.RestoreComplete | Should Be $True
        }
        Remove-DbaDbCertificate -SqlInstance $global:instance2 -Database Master -Certificate RestoreTestCert -Confirm:$false
        Remove-DbaDbMasterKey -SqlInstance $global:instance2 -Database Master -confirm:$false
        Remove-DbaDatabase -SqlInstance $global:instance2 -Database EncRestTest, certEncRestTest -confirm:$false
    }

    Context "Test restoring with StopAt" {
        $restoreOutput = Restore-DbaDatabase -SqlInstance $global:instance2 -Name StopAt2 -Path $global:appveyorlabrepo\sql2008-backups\StopAt -StopMark dbatoolstest -WithReplace
        $null = Restore-DbaDatabase -SqlInstance $global:instance2 -Name StopAt2 -Recover
        $sqlOut = Invoke-DbaQuery -SqlInstance $global:instance2 -Database StopAt2 -Query "select max(step) as ms from steps"
        It "Should have stoped at mark" {
            $sqlOut.ms | Should -Be 9876
        }
        $null = Remove-DbaDatabase -SqlInstance $global:instance2 -Database StopAt2
    }

    Context "Test restoring with StopAtBefore" {
        $restoreOutput = Restore-DbaDatabase -SqlInstance $global:instance2 -Name StopAt2 -Path $global:appveyorlabrepo\sql2008-backups\StopAt -StopMark dbatoolstest -WithReplace -StopBefore
        $null = Restore-DbaDatabase -SqlInstance $global:instance2 -Name StopAt2 -Recover
        $sqlOut = Invoke-DbaQuery -SqlInstance $global:instance2 -Database StopAt2 -Query "select max(step) as ms from steps"
        It "Should have stoped at mark" {
    ...
    Context "Test restoring with StopAt and StopAfterDate" {
        $restoreOutput = Restore-DbaDatabase -SqlInstance $global:instance2 -Name StopAt2 -Path $global:appveyorlabrepo\sql2008-backups\StopAt -StopMark dbatoolstest -StopAfterDate (Get-Date '2020-05-12 13:33:35') -WithReplace
        $null = Restore-DbaDatabase -SqlInstance $global:instance2 -Name StopAt2 -Recover
        $sqlOut = Invoke-DbaQuery -SqlInstance $global:instance2 -Database StopAt2 -Query "select max(step) as ms from steps"
        It "Should have stoped at mark" {
    ...
    Context "Warn if OutputScriptOnly and VerifyOnly specified together #6987" {
        $restoreOutput = Restore-DbaDatabase -SqlInstance $global:instance2 -Name StopAt2 -Path $global:appveyorlabrepo\sql2008-backups\StopAt -OutputScriptOnly -VerifyOnly -WarningVariable warnvar
        ...
        Context "Restores From Azure using SAS" {
            BeforeAll {
                ...
                if (Get-DbaCredential -SqlInstance $global:instance2 -Name "[$global:azureblob]" ) {
                    $sql = "DROP CREDENTIAL [$global:azureblob]"
                    $server.Query($sql)
                }
            ...
            It "Should restore cleanly" {
                $results = Restore-DbaDatabase -SqlInstance $global:instance2 -WithReplace -DatabaseName dbatoolsci_azure -Path $global:azureblob/dbatoolsci_azure.bak
                $results.BackupFile | Should -Be "$global:azureblob/dbatoolsci_azure.bak"
                $results.RestoreComplete | Should Be $True
            }
        }
    }
    ...
    if ($env:azurepasswd -and -not $env:appveyor) {
        Context "Restores Striped backup From Azure using SAS" {
            ...
            It "Should restore cleanly" {
                $results = @("$global:azureblob/az-1.bak", "$global:azureblob/az-2.bak", "$global:azureblob/az-3.bak") | Restore-DbaDatabase -SqlInstance $global:instance2 -DatabaseName azstripetest  -WithReplace -ReplaceDbNameInFile
                $results.RestoreComplete | Should Be $True
            }
        }
    }
    if ($env:azurelegacypasswd) {
        Context "Restores from Azure using Access Key" {
            ...
            It -Skip "supports legacy credential setups" {
                $results = Restore-DbaDatabase -SqlInstance $global:instance2 -WithReplace -DatabaseName dbatoolsci_azure -Path https://dbatools.blob.core.windows.net/legacy/dbatoolsci_azure.bak -AzureCredential dbatools_ci
