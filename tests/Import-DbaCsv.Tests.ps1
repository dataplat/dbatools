...
Describe "$CommandName Integration Tests" -Tag "IntegrationTests" {
    ...
    $path = "$global:appveyorlabrepo\csv\SuperSmall.csv"
    $CommaSeparatedWithHeader = "$global:appveyorlabrepo\csv\CommaSeparatedWithHeader.csv"
    $col1 = "$global:appveyorlabrepo\csv\cols.csv"
    $col2 = "$global:appveyorlabrepo\csv\col2.csv"
    $pipe3 = "$global:appveyorlabrepo\csv\pipe3.psv"
