...
Describe $CommandName -Tag IntegrationTests {
    BeforeAll {
        ...
        $db1 = New-DbaDatabase @splatDatabase
        $procName = "proc1"
    ...
    AfterAll {
        ...
        $db1 | Remove-DbaDatabase @splatRemove
    }
    ...
    Context "Command actually works" {
        ...
        It "Should have standard properties" {
            ...
            ($results[0].PsObject.Properties.Name | Where-Object Name -in $ExpectedProps | Sort-Object) | Should -Be ($ExpectedProps | Sort-Object)
        }
