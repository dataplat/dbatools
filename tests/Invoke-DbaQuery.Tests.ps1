...
Describe "Invoke-DbaQuery" {
    ...
    Context "Validate parameters" {
        ...
        It "Should have AppendServerInstance parameter" {
            $CommandUnderTest | Should -HaveParameter AppendServerInstance -Type SwitchParameter -Not -Mandatory
        }
        It "Should have MessagesToOutput parameter" {
            $CommandUnderTest | Should -HaveParameter MessagesToOutput -Type SwitchParameter -Not -Mandatory
        }
        ...
        It "Should have NoExec parameter" {
            $CommandUnderTest | Should -HaveParameter NoExec -Type SwitchParameter -Not -Mandatory
        }
