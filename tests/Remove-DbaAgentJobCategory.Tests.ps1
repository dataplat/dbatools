...
Describe $CommandName -Tag IntegrationTests {
    Context "New Agent Job Category is changed properly" {
        ...
        It "Remove the job categories" {
            $global:dbatoolsciOutput = Remove-DbaAgentJobCategory -SqlInstance $TestConfig.InstanceSingle -Category "CategoryTest1", "CategoryTest2", "CategoryTest3" -Confirm:$false
