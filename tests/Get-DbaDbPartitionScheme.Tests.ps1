...
"@
    ...
    Context "Output Validation" {
        BeforeAll {
            $result = Get-DbaDbPartitionScheme -SqlInstance $TestConfig.InstanceSingle -Database master -EnableException
        }

        It "Returns the documented output type" {
            $result | Should -BeOfType [Microsoft.SqlServer.Management.Smo.PartitionScheme]
        }
