...
Describe "$CommandName Integration Tests" -Tag "IntegrationTests" {
    ...
    Context "Command works" {
        It "Starts with the right data" {
            Invoke-DbaQuery -SqlInstance $global:instance2 -Database $db -Query "select * from people" | Should -Be $null
        }
        ...
        It "Generates the data" {
            Invoke-DbaQuery -SqlInstance $global:instance2 -Database $db -Query "select * from people" | Should -Not -Be $null
        }
    }
}