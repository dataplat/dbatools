...
Describe "Publish-DbaDacPackage" {
    Context "Validate parameters" {
        ...
        It "Should have GenerateDeploymentReport parameter" {
            $CommandUnderTest | Should -HaveParameter GenerateDeploymentReport -Type SwitchParameter
        }
        ...
        It "Should have IncludeSqlCmdVars parameter" {
            $CommandUnderTest | Should -HaveParameter IncludeSqlCmdVars -Type SwitchParameter
        }
