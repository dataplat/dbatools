...
SELECT 'áéíñóú¡¿' as SampleUTF8;"
    ...
    Context "DAC enabled" {
        ...
        It -Skip "Should throw error" {
            ...
            Invoke-DbaDbDecryptObject -SqlInstance $global:instance1 -Database $dbname -ObjectName DummyEncryptedStoredProcedure -WarningVariable warn -WarningAction SilentlyContinue
