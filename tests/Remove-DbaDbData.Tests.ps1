...
Describe "$CommandName Integration Tests" -Tags "IntegrationTests" {
    ...
    Context "Functionality" {
        ...
        It 'Removes Data for a specified database' {
            ...
            (Invoke-DbaQuery -SqlInstance $global:instance2 -Database $dbname1 -Query 'Select count(*) as rwCnt from dept').rwCnt | Should Be 0
        }
        ...
        It 'Views are recreated' {
            (Get-DbaDbView -SqlInstance $global:instance2 -Database $dbname1 -ExcludeSystemView).Name | Should Be 'vw_emp'
        }
    }
