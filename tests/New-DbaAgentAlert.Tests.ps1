...
Describe "$CommandName Integration Tests" -Tags "IntegrationTests" {
    BeforeEach {
        Get-DbaAgentAlert -SqlInstance $global:instance2, $global:instance3 -Alert "Test Alert", "Another Alert" | Remove-DbaAgentAlert -Confirm:$false
    }
    AfterAll {
        Get-DbaAgentAlert -SqlInstance $global:instance2, $global:instance3 -Alert "Test Alert", "Another Alert" | Remove-DbaAgentAlert -Confirm:$false
    }
    Context 'Creating a new SQL Server Agent alert' {
        ...
        It 'Should create a new alert' {
            ...
            Get-DbaAgentAlert -SqlInstance $global:instance2 -Alert $parms.Alert | Should -Not -BeNullOrEmpty
        }
        ...
        It 'Should create a new alert' {
            ...
            Get-DbaAgentAlert -SqlInstance $global:instance3 -Alert $parms.Alert | Should -Not -BeNullOrEmpty
        }
    }
}