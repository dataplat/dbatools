...
Describe $CommandName -Tag IntegrationTests {
    ...
    Context "When getting articles from a publication" -Skip:$global:skipRepl {
        It "Should return articles" {
            ...
            $result = Get-DbaReplArticle @splatArticle -OutVariable "global:dbatoolsciOutput"
            $result | Should -Not -BeNullOrEmpty
            $result.Name | Should -Contain "ReplicateMe"
    ...
    Context "Output validation" -Skip:$global:skipRepl {
        ...
        It "Should have accurate .OUTPUTS documentation" {
            ...
            $help.returnValues.returnValue.type.name | Should -Match "Microsoft\.SqlServer\.Replication\.Article"
        }
    }
}