...
Describe "$CommandName Integration Tests" -Tag "IntegrationTests" {
    BeforeAll {
        $random = Get-Random
        $job1Instance1 = New-DbaAgentJob -SqlInstance $global:instance1 -Job "dbatoolsci_job_1_$random"
        $job1Instance2 = New-DbaAgentJob -SqlInstance $global:instance2 -Job "dbatoolsci_job_1_$random"
        $agentStep1 = New-DbaAgentJobStep -SqlInstance $global:instance1 -Job $job1Instance1 -StepName "Step 1" -OnFailAction QuitWithFailure -OnSuccessAction QuitWithSuccess
        $agentStep1 = New-DbaAgentJobStep -SqlInstance $global:instance2 -Job $job1Instance2 -StepName "Step 1" -OnFailAction QuitWithFailure -OnSuccessAction QuitWithSuccess
        ...
        $credential = New-DbaCredential -SqlInstance $global:instance2 -Name "dbatoolsci_$random" -Identity "$($instance2.ComputerName)\$login" -Password $password
    ...
    AfterAll {
        ...
        Remove-DbaAgentJob -SqlInstance $global:instance1 -Job "dbatoolsci_job_1_$random" -Confirm:$false
        Remove-DbaAgentJob -SqlInstance $global:instance2 -Job "dbatoolsci_job_1_$random" -Confirm:$false
    ...
    Context "command works" {
        It "Change the job step name" {
            $results = Get-DbaAgentJob -SqlInstance $global:instance2 -Job $job1Instance2
            $results.JobSteps | Where-Object Id -eq 1 | Select-Object -ExpandProperty Name | Should -Be "Step 1"

            $jobStep = Set-DbaAgentJobStep -SqlInstance $global:instance2 -Job $job1Instance2 -StepName "Step 1" -NewName "Step 1 updated"
            $results = Get-DbaAgentJob -SqlInstance $global:instance2 -Job $job1Instance2
            $results.JobSteps | Where-Object Id -eq 1 | Select-Object -ExpandProperty Name | Should -Be "Step 1 updated"

            $jobStep = Set-DbaAgentJobStep -SqlInstance $global:instance2 -Job $job1Instance2 -StepName "Step 1 updated" -NewName "Step 1"
        }
        ...
        It "use the -Force to add a new step" {
            $jobStep = Set-DbaAgentJobStep -SqlInstance $global:instance2 -Job $job1Instance2 -StepName "Step 2" -Force
            $results = Get-DbaAgentJob -SqlInstance $global:instance2 -Job $job1Instance2
            $results.JobSteps | Where-Object Id -eq 1 | Select-Object -ExpandProperty Name | Should -Be "Step 1"
