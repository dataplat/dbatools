Describe "Integration Tests" -Tag "IntegrationTests" {
    ...
    It "connects to Azure" {
        ...
        Connect-DbaInstance -SqlInstance dbatooolstest.database.windows.net -SqlCredential $azurecred -Tenant $env:TENANTID | Select-Object -ExpandProperty ComputerName | Should -Be "dbatoolstest.database.windows.net"
