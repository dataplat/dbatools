...
Describe "Stop-DbaTrace Unit Tests" -Tag 'UnitTests' {
    BeforeAll {
        # Importing the function if needed
        # . "$PSScriptRoot\..\functions\Stop-DbaTrace.ps1"
    }
    ...
    Context "Validate parameters" {
        ...
        It "Should have Id as a parameter" {
            $CommandUnderTest | Should -HaveParameter Id -Type System.Int32[] -Mandatory:$false
        }
