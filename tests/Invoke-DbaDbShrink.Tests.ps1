...
Describe "$CommandName Unit Tests" -Tag 'UnitTests' {
    Context "Validate parameters" {
        ...
        $knownParameters = 'SqlInstance', 'SqlCredential', 'Database', 'ExcludeDatabase', 'AllUserDatabases', 'PercentFreeSpace', 'ShrinkMethod', 'StatementTimeout', 'LogsOnly', 'FileType', 'StepSize', 'ExcludeIndexStats', 'ExcludeUpdateUsage', 'EnableException'
