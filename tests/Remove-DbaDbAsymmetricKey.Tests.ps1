...
Describe "$CommandName Integration Tests" -Tag "IntegrationTests" {
    ...
    Context "Remove a certificate" {
        ...
        $results = Get-DbaDbAsymmetricKey -SqlInstance $global:instance2 -Name $keyname -Database $database -WarningVariable warnvar
    ...
    Context "Remove a specific certificate" {
        ...
        $results = Get-DbaDbAsymmetricKey -SqlInstance $global:instance2 -Database $database -WarningVariable warnvar
        ...
        Remove-DbaDbAsymmetricKey -SqlInstance $global:instance2 -Name $keyname2 -Database $database -confirm:$false
    }
}
