...
Describe "$CommandName Unit Tests" -Tag 'UnitTests' {
    Context "Validate parameters" {
        ...
        [object[]]$knownParameters = 'SqlInstance', 'SqlCredential', 'Database', 'Table', 'Column', 'Country', 'CountryCode', 'SampleCount', 'ExcludeTable', 'ExcludeColumn', 'KnownNamesFile', 'PatternsFile', 'ExcludeDefaultKnownNames', 'ExcludeDefaultPatterns', 'EnableException'
