...
Describe "$CommandName Integration Tests" -Tag "IntegrationTests" {
    ...
    Context "Command works" {
        It "starts with the right data" {
            Invoke-DbaQuery -SqlInstance $global:instance1 -Database $db -Query "SELECT * FROM Customer WHERE FirstName = 'Delores'" | Should -Not -Be $null
            Invoke-DbaQuery -SqlInstance $global:instance1 -Database $db -Query "SELECT * FROM Customer WHERE RandomText = '6011295760226704'" | Should -Not -Be $null
        }
