...
Describe "$CommandName Integration Tests" -Tags "IntegrationTests" {
    Context "New Agent Alert Category is changed properly" {
        ...
        It "supports piping SQL Agent alert category" {
            ...
            (Get-DbaAgentAlertCategory -SqlInstance $global:instance2 -Category $categoryName ) | Should -Not -BeNullOrEmpty
            Get-DbaAgentAlertCategory -SqlInstance $global:instance2 -Category $categoryName | Remove-DbaAgentAlertCategory -Confirm:$false
            (Get-DbaAgentAlertCategory -SqlInstance $global:instance2 -Category $categoryName ) | Should -BeNullOrEmpty
        }
    }
}