...
Describe "$CommandName Integration Tests" -Tag 'IntegrationTests' {
    BeforeAll {
        Get-DbaProcess -SqlInstance $global:instance1 -Database model | Stop-DbaProcess -Confirm:$false
        ...
        #$null = New-DbaDatabase -SqlInstance $global:instance2 -Name $dbNameNotMatches
