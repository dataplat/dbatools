...
Describe "$CommandName Integration Tests" -Tag "IntegrationTests" {
    ...
    AfterAll {
        $null = Invoke-DbaQuery -SqlInstance $global:instance1 -Database $dbname -Query "drop table $tablename, $tablename2"
    ...
    Context "Should create the table" {
        ...
        It "Creates the table" {
            (New-DbaDbTable -SqlInstance $global:instance1 -Database $dbname -Name $tablename -ColumnMap $map).Name | Should -Contain $tablename
        }
        It "Really created it" {
            (Get-DbaDbTable -SqlInstance $global:instance1 -Database $dbname).Name | Should -Contain $tablename
        }
    }
    Context "Should create the table with constraint on column" {
        ...
        It "Creates the table" {
            (New-DbaDbTable -SqlInstance $global:instance1 -Database $dbname -Name $tablename2 -ColumnMap $map).Name | Should -Contain $tablename2
        }
    ...
    Context "Should create the table with an identity column" {
        ...
        It "Creates the table" {
            (New-DbaDbTable -SqlInstance $global:instance1 -Database $dbname -Name $tablename3 -ColumnMap $map).Name | Should -Contain $tablename3
        }
    ...
    Context "Should create the table with using DefaultExpression and DefaultString" {
        ...
        It "Creates the table" {
            { $null = New-DbaDbTable -SqlInstance $global:instance1 -Database $dbname -Name $tablename4 -ColumnMap $map -EnableException } | Should Not Throw
        }
    }
    Context "Should create the table with a nvarcharmax column" {
        ...
        It "Creates the table" {
            (New-DbaDbTable -SqlInstance $global:instance1 -Database $dbname -Name $tablename5 -ColumnMap $map).Name | Should -Contain $tablename5
        }
