...
Describe "New-DbaDbTable" {
    ...
    AfterAll {
        $null = Invoke-DbaQuery -SqlInstance $script:instance1 -Database $dbname -Query "drop table if exists $tablename, $tablename2, $tablename3, $tablename4, $tablename5"
    ...
    Context "Should create the table" {
        ...
        It "Creates the table" {
            $result = New-DbaDbTable -SqlInstance $script:instance1 -Database $dbname -Name $tablename -ColumnMap $map
            $result.Name | Should -Contain $tablename
        }
        It "Really created it" {
            $tables = Get-DbaDbTable -SqlInstance $script:instance1 -Database $dbname
    ...
    Context "Should create the table with constraint on column" {
        ...
        It "Creates the table" {
            $result = New-DbaDbTable -SqlInstance $script:instance1 -Database $dbname -Name $tablename2 -ColumnMap $map
    ...
    Context "Should create the table with an identity column" {
        ...
        It "Creates the table" {
            $result = New-DbaDbTable -SqlInstance $script:instance1 -Database $dbname -Name $tablename3 -ColumnMap $map
    ...
    Context "Should create the table with a nvarcharmax column" {
        ...
        It "Creates the table" {
            $result = New-DbaDbTable -SqlInstance $script:instance1 -Database $dbname -Name $tablename5 -ColumnMap $map
