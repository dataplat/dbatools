...
Describe $CommandName -Tag IntegrationTests {
    ...
    Context "Command finds jobs using all parameters" {
        ...
        AfterAll {
            ...
            $null = Remove-DbaAgentJob -SqlInstance $TestConfig.instance2 -Job dbatoolsci_testjob, dbatoolsregr_testjob, dbatoolsci_testjob_disabled -ErrorAction SilentlyContinue
            $null = Remove-DbaAgentJobCategory -SqlInstance $TestConfig.instance2 -Category "dbatoolsci_job_category" -ErrorAction SilentlyContinue
