...
Describe $CommandName -Tag IntegrationTests {
    Context "Testing DBA MultiTool installer with download" {
        BeforeAll {
            ...
            $resultsDownload = Install-DbaMultiTool -SqlInstance $TestConfig.InstanceMulti1 -Database $database -Branch $branch -Force -Verbose:$false -OutVariable "global:dbatoolsciOutput"
