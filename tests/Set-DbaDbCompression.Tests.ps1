...
Describe "Set-DbaDbCompression" {
    ...
    Context "Validate parameters" {
        ...
        It "Should have ForceOfflineRebuilds as a parameter" {
            $CommandUnderTest | Should -HaveParameter ForceOfflineRebuilds -Type SwitchParameter
        }
    ...
    Context "Command excludes results for specified database" {
        ...
        It "Shouldn't get any results for $dbname" {
            $result = Set-DbaDbCompression -SqlInstance $script:instance2 -Database $dbname -ExcludeDatabase $dbname -MaxRunTime 5 -PercentCompression 0
