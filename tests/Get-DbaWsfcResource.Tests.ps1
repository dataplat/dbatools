...
Describe $CommandName -Tag IntegrationTests {
    BeforeAll {
        $results = Get-DbaWsfcResource -ComputerName $TestConfig.InstanceHadr -WarningVariable WarnVar -OutVariable "global:dbatoolsciOutput"
    }

    Context "Validate output" {
        It "Should return resource information without errors" {
    ...
    Context "Output validation" {
        ...
        It "Should have accurate .OUTPUTS documentation" {
            ...
            $help.returnValues.returnValue.type.name | Should -Match "MSCluster_Resource"
        }
    }
}