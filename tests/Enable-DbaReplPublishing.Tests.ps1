...
Describe "Enable-DbaReplPublishing" {
    ...
    Context "Validate parameters" {
        ...
        It "Should have SnapshotShare as a parameter" {
            $CommandUnderTest | Should -HaveParameter SnapshotShare -Type String -Mandatory:$false
        }
        It "Should have PublisherSqlLogin as a parameter" {
            $CommandUnderTest | Should -HaveParameter PublisherSqlLogin -Type PSCredential -Mandatory:$false
        }
