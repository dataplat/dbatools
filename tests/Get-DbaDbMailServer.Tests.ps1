...
Describe "Get-DbaDbMailServer" {
    Context "Validate parameters" {
        ...
        It "Should have Server as a non-mandatory parameter of type System.String[]" {
            $CommandUnderTest | Should -HaveParameter Server -Type System.String[] -Mandatory:$false
        }
