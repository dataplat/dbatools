...
Describe $CommandName -Tag IntegrationTests {
    BeforeAll {
        ...
        $linkedServerLogin1 = New-DbaLinkedServerLogin @splatLinkedLogin -LocalLogin $localLogin1Name
        $linkedServerLogin2 = New-DbaLinkedServerLogin @splatLinkedLogin -LocalLogin $localLogin2Name
        $linkedServerLogin3 = New-DbaLinkedServerLogin @splatLinkedLogin -LocalLogin $localLogin3Name
        $linkedServerLogin4 = New-DbaLinkedServerLogin @splatLinkedLogin -LocalLogin $localLogin4Name
        $linkedServerLogin5 = New-DbaLinkedServerLogin @splatLinkedLogin -LocalLogin $localLogin5Name
        $linkedServerLogin6 = New-DbaLinkedServerLogin @splatLinkedLogin -LocalLogin $localLogin6Name
        
        $splatMultiLinkedLogin = @{
            SqlInstance        = $instance2
        ...
        $linkedServerLogin7 = New-DbaLinkedServerLogin @splatMultiLinkedLogin
    ...
    AfterAll {
        ...
        Remove-DbaLogin -SqlInstance $instance2 -Login $localLogin1Name, $localLogin2Name, $localLogin3Name, $localLogin4Name, $localLogin5Name, $localLogin6Name, $localLogin7Name -Confirm:$false -ErrorAction SilentlyContinue
    ...
    Context "When removing linked server logins" {
        ...
        It "Should remove a single linked server login" {
        ...
        It "Should remove a linked server login via pipeline with a server instance passed in" {
        ...
        It "Should remove a linked server login via pipeline with a linked server passed in" {
        ...
        It "Should remove a linked server login via pipeline with a linked server login passed in" {
