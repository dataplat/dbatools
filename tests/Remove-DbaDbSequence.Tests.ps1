...
Describe "Remove-DbaDbSequence" {
    Context "Validate parameters" {
        ...
        It "Should have Sequence as a parameter" {
            $CommandUnderTest | Should -HaveParameter Sequence -Type String[] -Mandatory:$false
        }
        It "Should have Schema as a parameter" {
            $CommandUnderTest | Should -HaveParameter Schema -Type String[] -Mandatory:$false
        }
        It "Should have InputObject as a parameter" {
            $CommandUnderTest | Should -HaveParameter InputObject -Type Sequence[] -Mandatory:$false
        }
