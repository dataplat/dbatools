...
Describe "Install-DbaInstance" {
    ...
    Context "Validate parameters" {
        ...
        It "Should have Version parameter" {
            $command | Should -HaveParameter Version -Type String -Not -Mandatory
        }
        It "Should have InstanceName parameter" {
            $command | Should -HaveParameter InstanceName -Type String -Not -Mandatory
        }
        It "Should have SaCredential parameter" {
            $command | Should -HaveParameter SaCredential -Type PSCredential -Not -Mandatory
        }
        It "Should have Credential parameter" {
            $command | Should -HaveParameter Credential -Type PSCredential -Not -Mandatory
        }
        It "Should have Authentication parameter" {
            $command | Should -HaveParameter Authentication -Type String -Not -Mandatory
        }
        It "Should have ConfigurationFile parameter" {
            $command | Should -HaveParameter ConfigurationFile -Type Object -Not -Mandatory
        }
        It "Should have Configuration parameter" {
            $command | Should -HaveParameter Configuration -Type Hashtable -Not -Mandatory
        }
        It "Should have Path parameter" {
            $command | Should -HaveParameter Path -Type String[] -Not -Mandatory
        }
        It "Should have Feature parameter" {
            $command | Should -HaveParameter Feature -Type String[] -Not -Mandatory
        }
        It "Should have AuthenticationMode parameter" {
            $command | Should -HaveParameter AuthenticationMode -Type String -Not -Mandatory
        }
        It "Should have InstancePath parameter" {
            $command | Should -HaveParameter InstancePath -Type String -Not -Mandatory
        }
        It "Should have DataPath parameter" {
            $command | Should -HaveParameter DataPath -Type String -Not -Mandatory
        }
        It "Should have LogPath parameter" {
            $command | Should -HaveParameter LogPath -Type String -Not -Mandatory
        }
        It "Should have TempPath parameter" {
            $command | Should -HaveParameter TempPath -Type String -Not -Mandatory
        }
        It "Should have BackupPath parameter" {
            $command | Should -HaveParameter BackupPath -Type String -Not -Mandatory
        }
        It "Should have UpdateSourcePath parameter" {
            $command | Should -HaveParameter UpdateSourcePath -Type String -Not -Mandatory
        }
        It "Should have AdminAccount parameter" {
            $command | Should -HaveParameter AdminAccount -Type String[] -Not -Mandatory
        }
        It "Should have Port parameter" {
            $command | Should -HaveParameter Port -Type Int32 -Not -Mandatory
        }
        It "Should have Throttle parameter" {
            $command | Should -HaveParameter Throttle -Type Int32 -Not -Mandatory
        }
        It "Should have ProductID parameter" {
            $command | Should -HaveParameter ProductID -Type String -Not -Mandatory
        }
        It "Should have AsCollation parameter" {
            $command | Should -HaveParameter AsCollation -Type String -Not -Mandatory
        }
        It "Should have SqlCollation parameter" {
            $command | Should -HaveParameter SqlCollation -Type String -Not -Mandatory
        }
        It "Should have EngineCredential parameter" {
            $command | Should -HaveParameter EngineCredential -Type PSCredential -Not -Mandatory
        }
        It "Should have AgentCredential parameter" {
            $command | Should -HaveParameter AgentCredential -Type PSCredential -Not -Mandatory
        }
        It "Should have ASCredential parameter" {
            $command | Should -HaveParameter ASCredential -Type PSCredential -Not -Mandatory
        }
        It "Should have ISCredential parameter" {
            $command | Should -HaveParameter ISCredential -Type PSCredential -Not -Mandatory
        }
        It "Should have RSCredential parameter" {
            $command | Should -HaveParameter RSCredential -Type PSCredential -Not -Mandatory
        }
        It "Should have FTCredential parameter" {
            $command | Should -HaveParameter FTCredential -Type PSCredential -Not -Mandatory
        }
        It "Should have PBEngineCredential parameter" {
            $command | Should -HaveParameter PBEngineCredential -Type PSCredential -Not -Mandatory
        }
