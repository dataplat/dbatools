...
Describe "$CommandName Unit Tests" -Tags "UnitTests" {
    Context "Validate parameters" {
        ...
        [object[]]$knownParameters = 'SqlInstance', 'SqlCredential', 'ServerName', 'Name', 'Description', 'Group', 'InputObject', 'EnableException', 'OtherParams', 'ActiveDirectoryUserId', 'ActiveDirectoryTenant', 'ConnectionString'
