...
Describe $CommandName -Tag IntegrationTests {
    BeforeAll {
        ...
        # Create a temp directory for exported plans
    ...
    Context "When exporting execution plans" {
        It "Should export execution plans to disk" {
            $splatExport = @{
                SqlInstance = $TestConfig.InstanceSingle
                Database    = "master"
                Path        = $exportPath
            }
            $results = Export-DbaExecutionPlan @splatExport -OutVariable "global:dbatoolsciOutput"
