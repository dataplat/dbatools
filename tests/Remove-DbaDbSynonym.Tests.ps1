...
Describe $CommandName -Tag IntegrationTests {
    ...
    Context "Functionality" {
        It "Removes Synonyms" {
            ...
            $result1.Status.Count | Should -BeGreaterThan $result2.Status.Count
        ...
        It "Accepts a list of synonyms" {
            ...
            $result3.Status.Count | Should -BeGreaterThan $result4.Status.Count
        ...
        It "Excludes Synonyms" {
            ...
            $result5.Status.Count | Should -BeGreaterThan $result6.Status.Count
        ...
        It "Excludes Synonyms in a specified database" {
            ...
            $result11.Status.Count | Should -BeGreaterThan $result12.Status.Count
        ...
        It "Excludes Synonyms in a specified schema" {
            ...
            $result13.Status.Count | Should -BeGreaterThan $result14.Status.Count
        ...
        It "Accepts a list of schemas" {
            ...
            $result15.Status.Count | Should -BeGreaterThan $result16.Status.Count
        ...
        It "Accepts a list of databases" {
            ...
            $result17.Status.Count | Should -BeGreaterThan $result18.Status.Count
