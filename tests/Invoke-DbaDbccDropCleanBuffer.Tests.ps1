...
Describe "$commandname Integration Test" -Tag "IntegrationTests" {
    ...
    $result = Invoke-DbaDbccDropCleanBuffer -SqlInstance $global:instance1 -Confirm:$false
    ...
    Context "Works correctly" {
        ...
        It "returns the right results for -NoInformationalMessages" {
            $result = Invoke-DbaDbccDropCleanBuffer -SqlInstance $global:instance1 -NoInformationalMessages -Confirm:$false
