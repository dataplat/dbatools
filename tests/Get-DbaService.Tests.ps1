...
Describe "$commandname Integration Tests" -Tags "IntegrationTests" {
    ...
    Context "Command actually works" {
        ...
        $results = Get-DbaService -ComputerName $global:instance2 -Type Agent
        ...
        $results = Get-DbaService -ComputerName $global:instance2 -InstanceName $instanceName -Type Agent -AdvancedProperties
