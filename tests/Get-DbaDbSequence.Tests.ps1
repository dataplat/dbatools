...
Describe $CommandName -Tag IntegrationTests {
    ...
    BeforeAll {
        ...
        $sequence5 = New-DbaDbSequence @splatSequence5
    ...
    AfterAll {
        ...
        $null = $newDb, $newDb2 | Remove-DbaDatabase -Confirm:$false -ErrorAction SilentlyContinue
    ...
    Context "commands work as expected" {
        ...
        It "finds a sequence on an instance" {
            ...
            $sequence.Status.Count | Should -BeGreaterOrEqual 5
        }
        ...
        It "finds a sequence in a single database" {
            ...
            $sequence.Status.Count | Should -Be 4
        }
        ...
        It "finds a sequence in a single database by schema only" {
            ...
            $sequence.Status.Count | Should -Be 2
        }
