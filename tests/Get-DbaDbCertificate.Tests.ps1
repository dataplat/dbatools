...
Describe "Get-DbaDbCertificate" {
    Context "Validate parameters" {
        ...
        It "Should have Certificate as a parameter" {
            $CommandUnderTest | Should -HaveParameter Certificate -Type System.Object[] -Mandatory:$false
        }
        It "Should have Subject as a parameter" {
            $CommandUnderTest | Should -HaveParameter Subject -Type System.String[] -Mandatory:$false
        }
