...
Describe "$CommandName Integration Tests" -Tags "IntegrationTests" {
    BeforeAll {
        ...
        Restore-DbaDatabase -SqlInstance $global:instance1 -DatabaseName $WaitResourceDB -ReplaceDbNameInFile -Path $global:appveyorlabrepo\singlerestore\singlerestore.bak
        $sql = "
