...
Describe "ConvertTo-DbaXESession" {
    BeforeDiscovery {
...
"@
        ...
        AfterAll {
            Remove-DbaXESession -SqlInstance $global:instance2 -Session $global:name -Confirm:$false
            Remove-DbaTrace -SqlInstance $global:instance2 -Id $traceid -Confirm:$false
