...
Describe "$CommandName Integration Tests" -Tags "IntegrationTests" {
    ...
    Context "Test dbsize skip and cleanup (Issue 3968)" {
        $results1 = Restore-DbaDatabase -SqlInstance $global:instance1 -Database bigtestrest -Path $global:appveyorlabrepo\sql2008-backups\db1\FULL -ReplaceDbNameInFile
        Backup-DbaDatabase -SqlInstance $global:instance1 -Database bigtestrest
        $results1 = Restore-DbaDatabase -SqlInstance $global:instance1 -Database smalltestrest -Path $global:appveyorlabrepo\sql2008-backups\db2\FULL\SQL2008_db2_FULL_20170518_041738.bak -ReplaceDbNameInFile
