...
Describe "$CommandName Unit Tests" -Tag 'UnitTests' {
    Context "Validate parameters" {
        ...
        [object[]]$knownParameters = 'SqlInstance', 'SqlCredential', 'Database', 'Table', 'Column', 'Path', 'Locale', 'CharacterString', 'SampleCount', 'KnownNamesFile', 'PatternsFile', 'ExcludeDefaultKnownNames', 'ExcludeDefaultPatterns', 'Force', 'InputObject', 'EnableException'
