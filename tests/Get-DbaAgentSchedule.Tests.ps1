...
Describe "$commandname Integration Tests" -Tags "UnitTests" {
    BeforeAll {
        Write-Message -Level Warning -Message "BeforeAll start: Get-DbaAgentSchedule.Tests.ps1 testing with instance3=$($global:instance3) and instance2=$($global:instance2)"
        ...
        Write-Message -Level Warning -Message "BeforeAll end: Get-DbaAgentSchedule.Tests.ps1 testing with instance3=$($global:instance3) and instance2=$($global:instance2)"
    }
    AfterAll {
        Write-Message -Level Warning -Message "AfterAll start: Get-DbaAgentSchedule.Tests.ps1 testing with instance3=$($global:instance3) and instance2=$($global:instance2)"
        ...
        if ($null -ne $schedules) {
            ...
            Write-Message -Level Warning -Message "The schedules from $global:instance2 were returned as null"
        }
        ...
        if ($null -ne $schedules) {
            ...
            Write-Message -Level Warning -Message "The schedules from $global:instance3 were returned as null"
        }

        Write-Message -Level Warning -Message "AfterAll end: Get-DbaAgentSchedule.Tests.ps1 testing with instance3=$($global:instance3) and instance2=$($global:instance2)"
    }
