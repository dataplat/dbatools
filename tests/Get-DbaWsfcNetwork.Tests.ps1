...
Describe $CommandName -Tag IntegrationTests {
    BeforeAll {
        $results = Get-DbaWsfcNetwork -ComputerName $TestConfig.InstanceHadr -WarningVariable WarnVar -OutVariable "global:dbatoolsciOutput"
    }

    Context "Validate output" {
        It "Should return network information without errors" {
    ...
    Context "Output validation" {
        ...
        It "Should have accurate .OUTPUTS documentation" {
            ...
            $help.returnValues.returnValue.type.name | Should -Match "MSCluster_Network"
        }
    }
}
