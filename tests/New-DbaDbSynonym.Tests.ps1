...
Describe "New-DbaDbSynonym" {
    ...
    Context "Functionality" {
        ...
        It 'Add new synonym and returns results' {
            $result1 = New-DbaDbSynonym -SqlInstance $env:instance2 -Database $dbname -Synonym 'syn1' -BaseObject 'obj1'
        ...
        It 'Add new synonym with default schema' {
            $result2a = New-DbaDbSynonym -SqlInstance $env:instance2 -Database $dbname -Synonym 'syn2a' -BaseObject 'obj2a'
        ...
        It 'Add new synonym with specified schema' {
            $null = New-DbaDbSchema -SqlInstance $env:instance2 -Database $dbname -Schema 'sch2'
            $result2 = New-DbaDbSynonym -SqlInstance $env:instance2 -Database $dbname -Synonym 'syn2' -BaseObject 'obj2' -Schema 'sch2'
        ...
        It 'Add new synonym to list of databases' {
            $result3 = New-DbaDbSynonym -SqlInstance $env:instance2 -Database $dbname, $dbname2 -Synonym 'syn3' -BaseObject 'obj3'
        ...
        It 'Add new synonym to different schema' {
            $null = New-DbaDbSchema -SqlInstance $env:instance2 -Database $dbname -Schema 'sch4'
            $result4 = New-DbaDbSynonym -SqlInstance $env:instance2 -Database $dbname -Schema 'sch4' -Synonym 'syn4' -BaseObject 'obj4'
        ...
        It 'Add new synonym to with a base schema' {
            $null = New-DbaDbSchema -SqlInstance $env:instance2 -Database $dbname -Schema 'sch5'
            $result5 = New-DbaDbSynonym -SqlInstance $env:instance2 -Database $dbname -Schema 'sch5' -Synonym 'syn5' -BaseObject 'obj5' -BaseSchema 'bsch5'
        ...
        It 'Add new synonym to with a base database' {
            $null = New-DbaDbSchema -SqlInstance $env:instance2 -Database $dbname -Schema 'sch6'
            $result6 = New-DbaDbSynonym -SqlInstance $env:instance2 -Database $dbname -Schema 'sch6' -Synonym 'syn6' -BaseObject 'obj6' -BaseSchema 'bsch6' -BaseDatabase 'bdb6'
        ...
        It 'Add new synonym to with a base server' {
            $null = New-DbaDbSchema -SqlInstance $env:instance2 -Database $dbname -Schema 'sch7'
            $result7 = New-DbaDbSynonym -SqlInstance $env:instance2 -Database $dbname -Schema 'sch7' -Synonym 'syn7' -BaseObject 'obj7' -BaseSchema 'bsch7' -BaseDatabase 'bdb7' -BaseServer 'bsrv7'
