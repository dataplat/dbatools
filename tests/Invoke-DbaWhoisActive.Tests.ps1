...
Describe "$commandname Integration Tests" -Tags "IntegrationTests" {
    BeforeAll {
        $testzippath = "$global:appveyorlabrepo\CommunitySoftware\sp_whoisactive-12.00.zip"
    ...
    Context "Should Execute SPWhoisActive" {
        ...
        $results = Invoke-DbaWhoIsActive -SqlInstance $global:instance1
        ...
        $results = Invoke-DbaWhoIsActive -SqlInstance $global:instance1 -Database Tempdb
        ...
        $results = Invoke-DbaWhoIsActive -SqlInstance $global:instance1 -Database Tempdb -GetAverageTime
