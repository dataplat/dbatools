...
Describe "Get-DbaRgWorkloadGroup" {
    Context "Validate parameters" {
        ...
        It "Should have InputObject as a non-mandatory parameter of type ResourcePool[]" {
            $CommandUnderTest | Should -HaveParameter InputObject -Type ResourcePool[] -Not -Mandatory
        }
    ...
    Context "Command usage" {
        ...
        Context "Connects and retrieves workload groups" -ForEach $script:instance1, $script:instance2 {
            BeforeAll {
