...
Describe "$CommandName Unit Tests" -Tag 'UnitTests' {
    Context "Validate parameters" {
        ...
        [object[]]$knownParameters = 'SqlInstance', 'SqlCredential', 'Database', 'FilePath', 'Locale', 'CharacterString',
        'Table', 'Column', 'ExcludeTable', 'ExcludeColumn', 'MaxValue', 'ModulusFactor', 'ExactLength', 'ConnectionTimeout',
        'CommandTimeout', 'BatchSize', 'DictionaryFilePath', 'DictionaryExportPath', 'EnableException'
