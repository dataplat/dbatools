...
Describe "$commandName Integration Tests" -Tags "IntegrationTests" {
    if ($env:azuredbpasswd -eq "failstoooften") {
        Context "Run the tips against Azure database" {
            ...
            $results = Invoke-DbaAzSqlDbTip -SqlInstance $global:azureserver -Database test -SqlCredential $cred -ReturnAllTips
            ...
            It "Should have the right ComputerName" {
                $results.ComputerName | Should -Be $global:azureserver
            }
