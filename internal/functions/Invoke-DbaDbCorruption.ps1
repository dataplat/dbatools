function Invoke-DbaDbCorruption {
    ...
    try {
        ...
        Stop-Function -EnableException:$EnableException -Message "Error occured while establishing connection to $instance" -Category ConnectionError -ErrorRecord $_ -Target $SqlInstance
        return
    }
