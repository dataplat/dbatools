        ...
        foreach ($currentGroup in $currentVersionGroups) {
            ...
            if ($CumulativeUpdate -gt 0) {
                ...
                if (Test-Bound -Parameter ServicePack) {
                    ...
                    $targetKB = Test-DbaBuild -MajorVersion $currentMajorNumber -ServicePack $ServicePack -CumulativeUpdate $CumulativeUpdate
                } else {
                    ...
                    $targetKB = Test-DbaBuild -MajorVersion $currentMajorNumber -ServicePack $targetSP -CumulativeUpdate $CumulativeUpdate
                }
            } elseif ($ServicePack -gt 0) {
                #Service pack number was passed without CU - installing service pack
                $targetKB = Test-DbaBuild -MajorVersion $currentMajorNumber -ServicePack $ServicePack
            } elseif ($KB) {
                $targetKB = Test-DbaBuild -KB $KB
                ...
                if (!$latestCU.Compliant) {
                    ...
                    $targetKB = Test-DbaBuild -Build $latestCU.BuildTarget
                    ...
                    if ($Type -eq 'CumulativeUpdate') {
                        ...
                        $targetKB = Test-DbaBuild -MajorVersion $targetKB.NameLevel -ServicePack $targetSP
