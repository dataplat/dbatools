function New-DbaLogShippingSecondaryDatabase {
    ...
    try {
        ...
        Stop-Function -Message "Error occured while establishing connection to $instance" -Category ConnectionError -Target $SqlInstance -ErrorRecord $_ -Continue
    }
    ...
    try {
        ...
        Stop-Function -Message "Error occured while establishing connection to $instance" -Category ConnectionError -Target $PrimaryServer -ErrorRecord $_ -Continue
    }
