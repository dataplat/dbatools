    ...
    process {
        ...
        try {
            ...
            foreach ($component in $sqlComponents) {
                ...
                Write-Message -Level Verbose -Message "Converting version $($component.Version) to [version]"
                ...
                Write-Message -Level Verbose -Message "Converted version $($component.Version) to $newVersion"
