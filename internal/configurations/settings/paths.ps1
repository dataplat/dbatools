...
Set-DbatoolsConfig -FullName 'Path.DbatoolsExports' -Value (Join-DbaPath [Environment]::GetFolderPath("MyDocuments") "DbatoolsExport") -Initialize -Validation string -Handler { [Sqlcollaborative.Dbatools.Message.LogHost]::LoggingPath = $args[0] } -Description "The default path where dbatools writes scripts generated by Export-* functions."
