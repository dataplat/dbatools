@{
    ...
    RootModule             = 'dbatools.maintenance.psm1'
    ModuleVersion          = '2026.7.6'
    GUID                   = '19eff112-ffe6-4b12-941b-882fc7944373'
    Author                 = 'the dbatools team'
    CompanyName            = 'Dataplat'
    Copyright              = 'Copyright (c) 2026 by dbatools, licensed under MIT'
    Description            = 'dbatools.maintenance: keep it healthy - part of the dbatools module family'
