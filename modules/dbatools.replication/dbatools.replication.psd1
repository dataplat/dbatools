@{
    ...
    RootModule             = 'dbatools.replication.psm1'
    ModuleVersion          = '2026.7.6'
    GUID                   = 'f534a7ec-1005-4f4f-aaa3-5a0e4243c5e4'
    Author                 = 'the dbatools team'
    CompanyName            = 'Dataplat'
    Copyright              = 'Copyright (c) 2026 by dbatools, licensed under MIT'
    Description            = 'dbatools.replication: distributors, publications, articles, subscriptions - part of the dbatools module family'
