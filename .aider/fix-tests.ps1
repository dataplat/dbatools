...
foreach ($command in $commands) {
    ...
    aider --message "$cmdPrompt" --file $filename --sonnet --no-stream --cache-prompts --read /workspace/.aider/prompts/types.md /workspace/.aider/prompts/v4-to-v5.md /workspace/tests/constants.ps1
}