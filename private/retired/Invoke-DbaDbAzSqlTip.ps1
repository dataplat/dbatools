function Invoke-DbaDbAzSqlTip {
    ...
    .OUTPUTS
        ...
        Returns one object per tip recommendation generated by the Azure SQL Tips analysis script. Each object contains the recommendation details including the tip identifier, description, confidence level, and supporting information.
        ...
        - details: Additional context or detailed explanation specific to the tip
