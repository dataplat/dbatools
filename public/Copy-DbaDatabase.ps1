function Copy-DbaDatabase {
    ...
    .OUTPUTS
        ...
        Returns one object per database migrated.
        ...
        - DestinationDatabase: The database name on the destination instance (may differ from Name if -NewName or -Prefix was used)
