function Get-DbaAgentLog {
    ...
    .OUTPUTS
        ...
        Returns one DataRow object per log entry found. Each row is produced by SMO's JobServer.ReadErrorLog() method with additional NoteProperties added for ComputerName, InstanceName, and SqlInstance.
