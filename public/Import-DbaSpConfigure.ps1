function Import-DbaSpConfigure {
    ...
    .OUTPUTS
        ...
        Returns $true if the sp_configure settings were successfully applied to the destination instance, or $false if the operation failed. Warning messages may indicate configuration options requiring SQL Server restart, but do not affect the boolean return value.
