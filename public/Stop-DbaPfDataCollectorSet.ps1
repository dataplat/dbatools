function Stop-DbaPfDataCollectorSet {
    ...
    .OUTPUTS
        ...
        - State: Current state (should be "Ready" or "Stopped" after successful termination)
        ...
        - RemoteOutputLocation: UNC path to the output location
        - RemoteLatestOutputLocation: UNC path to the latest output location
        ...
        - Status: Numeric status code of the collector set
        - DataCollectorSetObject: Boolean flag indicating this is a DataCollectorSet object
