function Set-DbaAgentSchedule {
    ...
    .OUTPUTS
        ...
        Returns the updated JobSchedule object(s) for the modified schedule(s). When multiple jobs or multiple instances are modified, one object is returned per modified schedule. Output is from Get-DbaAgentSchedule which applies Select-DefaultView.

        Default display properties (via Select-DefaultView in Get-DbaAgentSchedule):
        - ComputerName: The computer name of the SQL Server instance
        - InstanceName: The SQL Server instance name
        - SqlInstance: The full SQL Server instance name (computer\instance)
        - ScheduleName: The name of the schedule (aliased from Name)
        ...
        - IsEnabled: Boolean indicating if the schedule is active
