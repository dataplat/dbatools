function Import-DbatoolsConfig {
    ...
    .OUTPUTS
        System.Management.Automation.PSCustomObject (when -Peek is specified)
        ...
        - Enforced (boolean) - Boolean indicating if the configuration value is enforced by policy
        - Policy (boolean) - Boolean indicating if the configuration value comes from policy
