function Start-DbaDbEncryption {
    ...
    .OUTPUTS
        ...
        In sequential mode (default), returns SMO Database objects from Enable-DbaDbEncryption with default display columns:
        ComputerName, InstanceName, SqlInstance, DatabaseName, EncryptionEnabled

        In parallel mode (-Parallel), returns PSCustomObject with properties:
        ComputerName, InstanceName, SqlInstance, DatabaseName, EncryptionEnabled, Status, Error
