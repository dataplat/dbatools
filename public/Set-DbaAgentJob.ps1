function Set-DbaAgentJob {
    ...
    .OUTPUTS
        ...
        Returns one modified SQL Server Agent job object per job that was successfully updated via Get-DbaAgentJob. The returned object reflects all changes applied during the modification operation.
        ...
        - CurrentRunRetryAttempt: Current retry attempt number for the running job
