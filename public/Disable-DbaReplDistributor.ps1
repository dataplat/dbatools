function Disable-DbaReplDistributor {
    ...
    .OUTPUTS
        ...
        Returns one ReplicationServer object showing the final state of the distributor after removal is complete. Output is only returned when the target instance is currently configured as a distributor; if it is not, a warning is raised instead.
