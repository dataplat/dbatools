function Get-DbaXESessionTargetFile {
    ...
    .OUTPUTS
        ...
        All properties from the standard PowerShell FileInfo object are available and can be accessed with Select-Object *.
    ...
    .EXAMPLE
        ...
        Returns the target files for the 'Long Running Queries' session on sql2016.
