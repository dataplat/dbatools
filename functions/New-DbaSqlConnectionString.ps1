...
.EXAMPLE
Get-DbaInstance -SqlInstance sql2016 | New-DbaSqlConnectionString

Builds a connected SMO object using Get-DbaInstance then extracts and displays the connection string
