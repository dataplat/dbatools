function New-DbaDacProfile {
    ...
    process {
        ...
        foreach ($instance in $SqlInstance) {
            ...
            $ConnectionString += $server.ConnectionContext.ConnectionString.Replace(';Application Name="dbatools PowerShell module - dbatools.io"', '').Replace(";Multiple Active Result Sets=False","")
