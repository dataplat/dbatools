...
#>
	...
	begin {
		if ($database -and $AllDatabases) {
			throw "-Database and -AllDatabases are mutually exclusive. Please choose only one. Quitting"
		}
...
Register-DbaTeppArgumentCompleter -Command Set-DbaMaxDop -Parameter Database, Exclude