...
The secondary databse will be called "db1_DR".
...
#>
    ...
    param(
        ...
        [parameter(Mandatory = $false)]
        [ValidateSet(4, "Daily", 8, "Weekly", 64, "AgentStart", 128, "IdleComputer")]
        ...
        [parameter(Mandatory = $false)]
        [ValidateSet(2, "Seconds", 4, "Minutes", 8, "Hours")]
        ...
        [Parameter(Mandatory = $false)]
        [int]$BackupScheduleFrequencyRelativeInterval,

        [Parameter(Mandatory = $false)]
        [object]$BackupScheduleFrequencyRecurrenceFactor,
        ...
        [parameter(Mandatory = $false)]
        [int]$CopyScheduleFrequencyInterval,
        ...
        [Parameter(Mandatory = $false)]
        [int]$CopyScheduleFrequencyRelativeInterval,
        ...
        [parameter(Mandatory = $false)]
        [int]$RestoreScheduleFrequencyInterval,
        ...
        [Parameter(Mandatory = $false)]
        [int]$RestoreScheduleFrequencyRelativeInterval,

        [Parameter(Mandatory = $false)]
        [object]$RestoreScheduleFrequencyRecurrenceFactor,
    ...
    begin {
        ...
        if (-not $BackupScheduleFrequencyInterval) {
            ...
            Write-Message -Message "Backup frequency interval set to $BackupScheduleFrequencyType" -Level Verbose 
        }
        if (-not $BackupScheduleFrequencySubdayType) {
            $BackupScheduleFrequencySubdayType = 4 
            Write-Message -Message "Backup frequency subday type set to $BackupScheduleFrequencyType" -Level Verbose 
        }
        if (-not $BackupScheduleFrequencySubdayInterval) {
            $BackupScheduleFrequencySubdayInterval = 15 
            Write-Message -Message "Backup frequency subday interval set to $BackupScheduleFrequencyType" -Level Verbose 
        }
        if (-not $BackupScheduleFrequencyRelativeInterval) {
            $BackupScheduleFrequencyRelativeInterval = 0 
            Write-Message -Message "Backup frequency relative interval set to $BackupScheduleFrequencyType" -Level Verbose 
        }
        if (-not $BackupScheduleFrequencyRecurrenceFactor) {
            $BackupScheduleFrequencyRecurrenceFactor = 0 
            Write-Message -Message "Backup frequency recurrence factor set to $BackupScheduleFrequencyType" -Level Verbose 
        }
        if (-not $CopyScheduleFrequencyType) {
            $CopyScheduleFrequencyType = 4 
        ...
        if (-not $CopyScheduleFrequencyInterval) {
            ...
            Write-Message -Message "Copy frequency interval set to $CopyScheduleFrequencyType" -Level Verbose 
        }
        if (-not $CopyScheduleFrequencySubdayType) {
            $CopyScheduleFrequencySubdayType = 4 
            Write-Message -Message "Copy frequency subday type set to $CopyScheduleFrequencyType" -Level Verbose 
        }
        if (-not $CopyScheduleFrequencySubdayInterval) {
            $CopyScheduleFrequencySubdayInterval = 15 
            Write-Message -Message "Copy frequency subday interval set to $CopyScheduleFrequencyType" -Level Verbose 
        }
        if (-not $CopyScheduleFrequencyRelativeInterval) {
            $CopyScheduleFrequencyRelativeInterval = 0 
            Write-Message -Message "Copy frequency relative interval set to $CopyScheduleFrequencyType" -Level Verbose 
        }
        if (-not $CopyScheduleFrequencyRecurrenceFactor) {
            $CopyScheduleFrequencyRecurrenceFactor = 0 
            Write-Message -Message "Copy frequency recurrence factor set to $CopyScheduleFrequencyType" -Level Verbose 
        }
        if (-not $RestoreScheduleFrequencyType) {
            $RestoreScheduleFrequencyType = 4 
        ...
        if (-not $RestoreScheduleFrequencyInterval) {
            ...
            Write-Message -Message "Restore frequency interval set to $RestoreScheduleFrequencyType" -Level Verbose 
        }
        if (-not $RestoreScheduleFrequencySubdayType) {
            $RestoreScheduleFrequencySubdayType = 4 
            Write-Message -Message "Restore frequency subday type set to $RestoreScheduleFrequencyType" -Level Verbose 
        }
        if (-not $RestoreScheduleFrequencySubdayInterval) {
            $RestoreScheduleFrequencySubdayInterval = 15 
            Write-Message -Message "Restore frequency subday interval set to $RestoreScheduleFrequencyType" -Level Verbose 
        }
        if (-not $RestoreScheduleFrequencyRelativeInterval) {
            $RestoreScheduleFrequencyRelativeInterval = 0 
            Write-Message -Message "Restore frequency relative interval set to $RestoreScheduleFrequencyType" -Level Verbose 
        }
