...
#>
	...
	process {
		...
		Test-DbaDeprecation -DeprecatedOn "1.0.0" -Silent:$true -Alias Show-SqlWhoIsActive -CustomMessage "Show-SqlWhoIsActive is no longer supported. Use Invoke-DbaWhoIsActive | Out-GridView for similar results."
	}
}