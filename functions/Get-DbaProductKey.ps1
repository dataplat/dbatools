        ...
        foreach ($computer in $ComputerName) {
            ...
            foreach ($instanceReg in $registryroot) {
                try {
                    ...
                    Stop-Function -Message "Error occured while establishing connection to $instance" -Category ConnectionError -ErrorRecord $_ -Target $instanceReg.SqlInstance -Continue
                }
