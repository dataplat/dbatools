Function Get-SqlClusterActiveNode
{
<#
.SYNOPSIS
...
.LINK
https://dbatools.io/Get-SqlClusterActiveNode

.EXAMPLE
Get-SqlClusterActiveNode -SqlServer sqlcluster

Returns a simple string with the ComputerNamePhysicalNetBIOS property

.EXAMPLE
Get-SqlClusterActiveNode -SqlServer sqlcluster -Detailed
