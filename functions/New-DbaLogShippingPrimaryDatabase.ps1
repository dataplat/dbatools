...
.PARAMETER ThressholdAlertEnabled
...
.EXAMPLE   
New-DbaLogShippingPrimaryDatabase -SqlInstance sql1 -Database DB1 -BackupDirectory D:\data\logshipping -BackupJob LSBackup_DB1 -BackupRetention 4320 -BackupShare "\\sql1\logshipping" -BackupThresshold 60 -BackupCompression $true -HistoryRetention 14420 -MonitorServer 'sql1' -ThressholdAlertEnabled 1 
...
#>
    ...
    if ($ThressholdAlertEnabled) {
        [int]$ThressholdAlertEnabled = 1
        Write-Message -Message "Setting thresshold alert to $ThressholdAlertEnabled." -Level Verbose
    }
    else {
        [int]$ThressholdAlertEnabled = 0
        Write-Message -Message "Setting thresshold alert to $ThressholdAlertEnabled." -Level Verbose
    }
    ...
    $Query = "
        ...
        EXEC master.dbo.sp_add_log_shipping_primary_database 
            ...
            ,@threshold_alert_enabled = $ThressholdAlertEnabled
