...
.LINK
https://dbatools.io/Show-DbaGitHubDemo

.EXAMPLE
Show-DbaGitHubDemo -SqlServer sqlserver2014a
Copies all policies and conditions from sqlserver2014a to sqlcluster, using Windows credentials. 

.EXAMPLE   
Show-DbaGitHubDemo -SqlServer sqlserver2014a -SqlCredential $cred
Does this, using SQL credentials for sqlserver2014a and Windows credentials for sqlcluster.

.EXAMPLE   
Show-DbaGitHubDemo -SqlServer sqlserver2014 -WhatIf
Shows what would happen if the command were executed.
	
.EXAMPLE   
Show-DbaGitHubDemo -SqlServer sqlserver2014a -Policy 'xp_cmdshell must be disabled'
Does this 
#>
