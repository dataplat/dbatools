function New-DbaDbPartitionFunction {
    <#
    .SYNOPSIS
        Create new synonym for each database(s) / instance(s) of SQL Server.

    .DESCRIPTION
        The New-DbaDbPartitionFunction creates new synonym on database(s) / instance(s) of SQL Server.
   ...
   .PARAMETER SqlInstance
    ...
    .LINK
        https://dbatools.io/New-DbaDbPartitionFunction

        .EXAMPLE
        PS C:\> New-DbaDbPartitionFunction -SqlInstance sql2017a -Database db1 -Synonym synObj1 -BaseObject Obj1
    ...
    .EXAMPLE
        PS C:\> New-DbaDbPartitionFunction -SqlInstance sql2017a -Database db1 -Schema sch1 -Synonym synObj1 -BaseObject Obj1
    ...
    .EXAMPLE
        PS C:\> New-DbaDbPartitionFunction -SqlInstance sql2017a -Database db1 -Schema sch1 -Synonym synObj1 -BaseObject Obj1 -BaseSchema bSch2
    ...
    .EXAMPLE
        PS C:\> New-DbaDbPartitionFunction -SqlInstance sql2017a -Database db1 -Schema sch1 -Synonym synObj1 -BaseObject Obj1 -BaseSchema bSch2 -BaseDatabase bDb3
    ...
    .EXAMPLE
        PS C:\> New-DbaDbPartitionFunction -SqlInstance sql2017a -Database db1 -Schema sch1 -Synonym synObj1 -BaseObject Obj1 -BaseSchema bSch2 -BaseDatabase bDb3 -BaseServer bSrv4
    ...
    .EXAMPLE
        PS C:\> Get-DbaDatabase -SqlInstance sql2017a -ExcludeSystem | New-DbaDbPartitionFunction -Synonym synObj1 -BaseObject Obj1
