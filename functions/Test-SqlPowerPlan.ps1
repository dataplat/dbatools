...
<#
.SYNOPSIS 
Test-SqlPowerPlan migrates SQL Agent categories from one SQL Server to another. This is similar to sp_add_category.
...
.EXAMPLE
Test-SqlPowerPlan -SqlServer sqlserver2014a
Copies all policies and conditions from sqlserver2014a to sqlcluster, using Windows credentials. 

.EXAMPLE   
Test-SqlPowerPlan -SqlServer sqlserver2014a -SqlCredential $cred
Does this, using SQL credentials for sqlserver2014a and Windows credentials for sqlcluster.

.EXAMPLE   
Test-SqlPowerPlan -SqlServer sqlserver2014 -WhatIf
Shows what would happen if the command were executed.
	
.EXAMPLE   
Test-SqlPowerPlan -SqlServer sqlserver2014a -Policy 'xp_cmdshell must be disabled'
Does this 
#>
