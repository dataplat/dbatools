function Enable-DbaTraceFlag {
	...
	.LINK 
		https://dbatools.io/Enable-DbaTraceFlagUsage

	.EXAMPLE   
		Enable-DbaTraceFlagUsage -SqlInstance sql2008, sql2012
		Return the 80 (20 x 4 types) top usage results by duration, frequency, IO, and CPU servers for servers sql2008 and sql2012

	.EXAMPLE   
		Enable-DbaTraceFlagUsage -SqlInstance sql2008 -Type Duration, Frequency -Database TestDB
		Return the highest usage by duration (top 20) and frequency (top 20) for the TestDB on sql2008

	.EXAMPLE   
		Enable-DbaTraceFlagUsage -SqlInstance sql2016 -Limit 30
		Return the highest usage by duration (top 30) and frequency (top 30) for the TestDB on sql2016
	
	.EXAMPLE
	Enable-DbaTraceFlagUsage -SqlInstance sql2008, sql2012 -ExcludeSystem
	...
	.EXAMPLE   
		Enable-DbaTraceFlagUsage -SqlInstance sql2016| Select *
