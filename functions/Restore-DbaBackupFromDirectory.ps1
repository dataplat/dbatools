...
#>	
	...
	DynamicParam
	{
		...
		Test-DbaDeprecation -DeprecatedOn "1.0.0" -Silent:$true -Alias Restore-SqlBackupFromDirectory -CustomMessage "Restore-DbaDatabase works way better. Please use that instead."
	}
}
