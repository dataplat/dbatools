...
#>
	...
	BEGIN
	{
		...
		$sourceserver = Connect-SqlServer -SqlServer $SqlInstance -SqlCredential $SourceSqlCredential
	}
...
'
	...
	END
	{
		...
		Test-DbaDeprecation -DeprecatedOn "1.0.0" -Silent:$false -Alias Show-SqlInstanceFileSystem
	}
}
