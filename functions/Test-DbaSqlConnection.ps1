Function Test-DbaSqlConnection
{
<# 
.SYNOPSIS 
Exported function. Tests a the connection to a single instance and shows the output. Not actually a fan of the output. Needs work.

.EXAMPLE
Test-DbaSqlConnection sql01
